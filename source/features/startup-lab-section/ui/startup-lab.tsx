...
export const StartupLab: React.FC<StartupLabProps> = ({
    info1,
    cards,
    info2,
    contactURL,
            ...
            >
                ...
                >
                    {isLoading ? (
                        ...
                        && 'data' in technologiesData
                        && technologiesData.data.data ? (
                        <StartupLabMenu
                            link={contactURL}
                            data={technologiesData.data.data.map(
                                el => {
                                    return {
                                        title: el.name,
                                        content: <section className={classes.tabContent}>
                                            <p>{el.primary_info}</p>
