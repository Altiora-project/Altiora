...
export const MegaphoneIcon: React.FC<typeIconProps> = ({ size, ...otherProps }) => {
  if (size === 'sm') {
    return (
      <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...otherProps}>
        <path
  ...
  if (size === 'md') {
    return (
      <svg width="41" height="31" viewBox="0 0 41 31" fill="none" xmlns="http://www.w3.org/2000/svg" {...otherProps}>
        <path
  ...
  if (size === 'lg' || size === undefined)
    return (
      <svg width="50" height="38" viewBox="0 0 50 38" fill="none" xmlns="http://www.w3.org/2000/svg" {...otherProps}>
        <path
