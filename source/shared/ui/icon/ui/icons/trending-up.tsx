...
export const TrendingUpIcon: React.FC<typeIconProps> = ({ size, ...otherProps }) => {
  if (size === 'sm') {
    return (
      <svg width="22" height="13" viewBox="0 0 22 13" fill="none" xmlns="http://www.w3.org/2000/svg" {...otherProps}>
        <path
  ...
  if (size === 'lg' || size === undefined)
    return (
      <svg width="45" height="25" viewBox="0 0 45 25" fill="none" xmlns="http://www.w3.org/2000/svg" {...otherProps}>
        <path
